  ...
  <div id="home" class="intro route bg-image" style="background-image: url(img/home1.jpg);background-size: cover; ">
   ...
   <?php
    ...
    if (mysqli_num_rows($run)==0){
      ...
      <div class='table-cell'>
        <div class='container'>
          <p class='display-6 color-d'>Event Date :2023/02/10 <b>Time :</b>$wtime  </p>
          <p class='display-6 color-d'><b>Venue</b>: Banglore  </p>
          <h1 class='intro-title mb-4'>$wname</h1>
          <p class='intro-subtitle'><span class='text-slider-items'>dance in your own style!!</span><strong class='text-slider'></strong></p>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/Sujata.jpg" alt="" class="rounded-circle b-shadow-a" width="150" height="150">
                <span class="author">Sujata</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  I am Sujata Chanda , pursuing  BE from computer science and Engeneering From Visvesvaraya Technological University.I am Good at web devlopment.I am Basically From Shillong. Today's Education is Just Like a Jumbled Game where people Uses to try those things where their Field of intrest lies within.So I am also trying my hand Best in web Devlopment.
                </p>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico text-white">
                      <li><span class="ion-ios-location"></span>Ayyapa nagar Kr Puram, Bangalore</li>
                      <li><span class="ion-ios-telephone"></span> +919608472701</li>
                      <li><span class="ion-email"></span> Sujata@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
