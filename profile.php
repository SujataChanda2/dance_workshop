      ...
      <div class='table-cell'>
        <div class='container'>
          ...
          <p class='intro-subtitle'><span class='text-slider-items'>dance in your own style!!</span><strong class='text-slider'></strong></p>
           ...
           <p class='pt-3'><a class='btn btn-primary btn js-scroll px-4 pjoin' wid='$wid' tid='$wtime'did='2023/02/10' href='#ab' role='button'>Join Event</a></p>
